...
<section class="light-gray-bg pv-30 clearfix">
  <div class="container">
    <div class="row justify-content-md-center">
      <div class="col-lg-8">
        <h2 class="text-center mt-4">Últimas <strong>Novedades</strong></h2>
        <div class="separator"></div>
        <p class="large text-center">Aquí encontrarás las últimas noticias que compartimos con vos, esta sección te permitirá estar informad@ de nuestras actividades.</p>
      </div>
    </div>
    <div class="row">
      <div class="col-lg-4">
    ...
    <div class="row">
      <div class="col-12">
        <div class="call-to-action text-center">
          <div class="row">
            <div class="col-lg-8">
              <h1 class="title">Imprimir Constancia de matrícula</h1>
              <p>Recuerda que para poder imprimir la constancia de matrícula, debe tener al día el pago de la mensualidad.</p>
            </div>
            <div class="col-lg-4">
              <br>
